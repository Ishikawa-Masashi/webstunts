...
export class JSegment {
      ...
      if (fA01 > 0) {
        if (fB0 >= 0) {
          ...
          if (-fTmp >= fA01) {
            ...
            fT = -fTmp / fA01;
            fSqrDist =
              fA00 + 2 * fB0 + fC + fT * (fA11 * fT + 2 * (fA01 + fB1));
          }
        }
      } else {
        if (-fB0 >= fA00) {
  ...
  segmentBoxDistanceSq(out, rkBox, boxState) {
    ...
    if (obj[3] >= 0) {
      if (obj[3] <= 1) {
        ...
        fSqrDistance = this.sqrDistancePoint(
          out,
          this.origin.add(this.delta),
          rkBox,
          boxState
        );
        out[3] = 1;
  ...
  sqrDistanceLine(out, rkLine, rkBox, boxState) {
    ...
    kPnt = new Vector3D(
      kDiff.dotProduct(orientationCols[0]),
      kDiff.dotProduct(orientationCols[1]),
      kDiff.dotProduct(orientationCols[2])
    );

    kDir = new Vector3D(
      rkLine.dir.dotProduct(orientationCols[0]),
  ...
  sqrDistancePoint(out, rkPoint, rkBox, boxState) {
    ...
    kClosest = new Vector3D(
      kDiff.dotProduct(orientationVector[0]),
    ...
    if (rkDirArr[i0] * kPpEArr[i1] >= rkDirArr[i1] * rkPmEArr[i0]) {
      if (rkDirArr[i0] * kPpEArr[i2] >= rkDirArr[i2] * rkPmEArr[i0]) {
        ...
        fTmp =
          fLSqr * kPpEArr[i1] -
          rkDirArr[i1] *
            (rkDirArr[i0] * rkPmEArr[i0] + rkDirArr[i2] * kPpEArr[i2]);
        if (fTmp <= 2 * fLSqr * boxHalfArr[i1]) {
          fT = fTmp / fLSqr;
          fLSqr += rkDirArr[i1] * rkDirArr[i1];
          fTmp = kPpEArr[i1] - fT;
          fDelta =
            rkDirArr[i0] * rkPmEArr[i0] +
            rkDirArr[i1] * fTmp +
            rkDirArr[i2] * kPpEArr[i2];
          fParam = -fDelta / fLSqr;
          out.rfSqrDistance +=
            rkPmEArr[i0] * rkPmEArr[i0] +
            fTmp * fTmp +
            kPpEArr[i2] * kPpEArr[i2] +
            fDelta * fParam;
          ...
          fDelta =
            rkDirArr[i0] * rkPmEArr[i0] +
            rkDirArr[i1] * rkPmEArr[i1] +
            rkDirArr[i2] * kPpEArr[i2];
          fParam = -fDelta / fLSqr;
          out.rfSqrDistance +=
            rkPmEArr[i0] * rkPmEArr[i0] +
            rkPmEArr[i1] * rkPmEArr[i1] +
            kPpEArr[i2] * kPpEArr[i2] +
            fDelta * fParam;
      ...
      if (rkDirArr[i0] * kPpEArr[i2] >= rkDirArr[i2] * rkPmEArr[i0]) {
        ...
        fTmp =
          fLSqr * kPpEArr[i2] -
          rkDirArr[i2] *
            (rkDirArr[i0] * rkPmEArr[i0] + rkDirArr[i1] * kPpEArr[i1]);
        if (fTmp <= 2 * fLSqr * boxHalfArr[i2]) {
          ...
          fDelta =
            rkDirArr[i0] * rkPmEArr[i0] +
            rkDirArr[i1] * kPpEArr[i1] +
            rkDirArr[i2] * fTmp;
          fParam = -fDelta / fLSqr;
          out.rfSqrDistance +=
            rkPmEArr[i0] * rkPmEArr[i0] +
            kPpEArr[i1] * kPpEArr[i1] +
            fTmp * fTmp +
            fDelta * fParam;
          ...
          fDelta =
            rkDirArr[i0] * rkPmEArr[i0] +
            rkDirArr[i1] * kPpEArr[i1] +
            rkDirArr[i2] * rkPmEArr[i2];
          fParam = -fDelta / fLSqr;
          out.rfSqrDistance +=
            rkPmEArr[i0] * rkPmEArr[i0] +
            kPpEArr[i1] * kPpEArr[i1] +
            rkPmEArr[i2] * rkPmEArr[i2] +
            fDelta * fParam;
  ...
  case0(out, i0, i1, i2, rkDir, rkBox) {
    ...
    var fPmE0 = rkPntArr[i0] - boxHalfArr[i0],
      fPmE1 = rkPntArr[i1] - boxHalfArr[i1],
      fProd0 = rkDirArr[i1] * fPmE0,
    ...
    if (fProd0 >= fProd1) {
      ...
      if (fDelta >= 0) {
        fInvLSqr =
          1 / (rkDirArr[i0] * rkDirArr[i0] + rkDirArr[i1] * rkDirArr[i1]);
        out.rfSqrDistance += fDelta * fDelta * fInvLSqr;

        rkPntArr[i1] = -boxHalfArr[i1];
        out.pfLParam =
          -(rkDirArr[i0] * fPmE0 + rkDirArr[i1] * fPpE1) * fInvLSqr;
      } else {
        fInv = 1 / rkDirArr[i0];
      ...
      if (fDelta >= 0) {
        ...
        rkPntArr[i0] = -boxHalfArr[i0];
        out.pfLParam =
          -(rkDirArr[i0] * fPpE0 + rkDirArr[i1] * fPmE1) * fInvLSqr;
      } else {
        fInv = 1 / rkDirArr[i1];
